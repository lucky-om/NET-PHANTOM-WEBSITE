    ...
    function runCommand(cmd) {
        ...
        switch(val) {
            ...
            case "sniff":
                ...
                cliFeedback.innerHTML = `[+] Initializing WinPcap/Npcap socket hooks...<br>[+] Active Interface: <strong>Wi-Fi (wlan0)</strong><br>[+] Running NetPhantom HUD v3.2.2 Packet Engine...`;
...
function initStandalonePhantomAIPage() {
    ...
    async function generatePhantomAiResponse(query) {
        ...
        const API_KEY = window.GROQ_API_KEY || ""; // User must inject this securely
